...
%
%    \resumeSubheading
%      {Treasurer}{August 2020 -- May 2022}
...
%
%    \resumeSubheading
%      {Electrical Team Lead}{September 2021 -- September 2022}
...
\section{Projects}
    \resumeSubHeadingListStart
      ...
      {\textbf{Automated Transit Enforcement} $|$ \emph{Python, Git, Software Dev, Hardware Dev}}{September 2023 -- May 2024}
      \resumeItemListStart
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Design and Simulation}{: Cadence Allegro, MODELSIM, NI Multisim, Simulink, PS:SE, Xilinx Vivado, Intel Quartus Prime, SIMULINK}\\
     \textbf{Hardware Tools}{: Oscilloscope, Spectrum Analyzer, Multimeter, Soldering, Power Supplies, STM MCU, Pynq Z2 FPGA, PIC MCU}\\
