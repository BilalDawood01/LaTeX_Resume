  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        % \resumeItem{Created test cases to verify and fix tool output, showcasing analytical and debugging skills.}
...
%-------------------------------------------
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Boosted backend data management efficiency by 60\% via implementing 4 new classes and optimizing log outputs (Reduced unnecessary data logging and cleaned output formatting).}
